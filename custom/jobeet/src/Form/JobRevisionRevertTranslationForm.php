...
/**
 * Provides a form for reverting a Job revision for a single translation.
 *
 * @ingroup jobeet
 */
class JobRevisionRevertTranslationForm extends JobRevisionRevertForm {
  ...
  /**
   * Constructs a new JobRevisionRevertTranslationForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity.manager')->getStorage('job'),
  ...
  protected function prepareRevertedRevision(JobInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\jobeet\Entity\JobInterface $default_revision */
    $latest_revision = $this->JobStorage->load($revision->id());
